...
namespace DodgeBall.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(DodgeBallDbContext context)
        {
            _context = context;    
        }
        ...
        {
            var dodgeBallDbContext = _context.Players.Include(p => p.Team);
            return View(await dodgeBallDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("PlayerId,Name,PaidDues,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,Name,PaidDues,TeamId")] Player player)
        {
